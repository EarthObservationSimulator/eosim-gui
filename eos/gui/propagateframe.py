...
class PropagateFrame(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        pexec_btn = ttk.Button(pexec_frame, text="Propagate", command=self.click_pexec_btn)
        pexec_btn.grid(row=0, column=0, columnspan=3, sticky='w', ipadx=10, ipady=10, padx=20)
