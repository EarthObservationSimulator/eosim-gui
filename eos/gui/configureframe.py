...
class ConfigureFrame(ttk.Frame):
    ...
    def click_mission_btn(self):      
        ...
        # create and configure child window
        ...
        miss_win.columnconfigure(1,weight=2)
              
        # create and configure frames in the child window
        helparea = ttk.Frame(miss_win, style ='helparea.TFrame')
        helparea.grid(row=0, column=1, rowspan=3, sticky='nswe')  

        epoch_frame = ttk.Frame(miss_win)
        epoch_frame.grid(row=0, column=0)

        duration_frame = ttk.Frame(miss_win)
        duration_frame.grid(row=1, column=0)
        
        okcancel_frame = ttk.Frame(miss_win)
        ...
        epoch_year_entry.insert(0,"Year")
        ...
        epoch_month_entry.insert(0,"Month")
        ...
        epoch_hour_entry.insert(0,"Hour")
        ...
        epoch_min_entry.insert(0,"Minute")
        ...
        epoch_sec_entry.insert(0,"Second")
